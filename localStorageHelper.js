function localStorageHelper() {
	...
	this.warn = function(a){window.console&&window.console.warn&&console.warn.apply(console,["localStorageHelper Warning:\t",a,Array.prototype.slice.call(arguments,1)])};
	this.error = function(){window.console&&window.console.error&&console.error.apply(console,["localStorageHelper ERROR:\t",arguments])};
